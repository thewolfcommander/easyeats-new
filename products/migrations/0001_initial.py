    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(null=True, upload_to='category_feature_image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preparation_time', models.CharField(help_text='In minutes', max_length=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('uttarakhand', 'Uttarakhand')], default='uttarakhand', max_length=255, null=True)),
                ('country', models.CharField(choices=[('india', 'India')], default='india', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(null=True, upload_to='collection_feature_image')),
                ('name', models.CharField(max_length=255, null=True)),
                ('summary', models.CharField(max_length=255, null=True)),
                ('description', models.TextField(null=True)),
                ('active', models.BooleanField(default=True)),
